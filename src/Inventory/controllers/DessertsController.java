...
public class DessertsController {
        ...
        @FXML
        void FruitSalad(ActionEvent event) {
            try {
                URL url = Paths.get("./src/Inventory/views/Desserts_FruitSalad.fxml").toUri().toURL();
        ...
        @FXML
        void HaloHalo(ActionEvent event) {
            try {
                URL url = Paths.get("./src/Inventory/views/Desserts_HaloHalo.fxml").toUri().toURL();
        ...
        @FXML
        void LecheFlan(ActionEvent event) {
            try {
                URL url = Paths.get("./src/Inventory/views/Desserts_LecheFlan.fxml").toUri().toURL();
        ...
        @FXML
        void MangoGraham(ActionEvent event) {
            try {
                URL url = Paths.get("./src/Inventory/views/Desserts_MangoGraham.fxml").toUri().toURL();
