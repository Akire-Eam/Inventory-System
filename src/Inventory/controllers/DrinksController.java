...
public class DrinksController {
    ...
    @FXML
    void BukoJuice(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Drinks_BukoJuice.fxml").toUri().toURL();
    ...
    @FXML
    void MangoShake(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Drinks_MangoShake.fxml").toUri().toURL();
    ...
    void Pepsi(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Drinks_Pepsi.fxml").toUri().toURL();
    ...
    @FXML
    void SanMig(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Drinks_SanMig.fxml").toUri().toURL();
