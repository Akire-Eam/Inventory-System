...
public class AppetizersController {
    ...
    @FXML
    void BeefEmpanada(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Appetizers_BeefEmpanadaFXML.fxml").toUri().toURL();
    ...
    @FXML
    void ChicharongBulaklak(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Appetizers_ChicharongBulaklakFXML.fxml").toUri().toURL();
    ...
    @FXML
    void LumpiangShanghai(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Appetizers_LumpiangShanghaiFXML.fxml").toUri().toURL();
    ...
    @FXML
    void PorkSiomai(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Appetizers_PorkSiomaiFXML.fxml").toUri().toURL();
    ...
    @FXML
    void SizzlingSisig(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/Appetizers_SizzlingSisigFXML.fxml").toUri().toURL();
