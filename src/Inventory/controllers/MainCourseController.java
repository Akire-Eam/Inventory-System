...
public class MainCourseController {
    ...
    @FXML
    void BeefCaldereta(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/MainCourse_BeefCaldereta.fxml").toUri().toURL();
    ...
    @FXML
    void ChickenAdobo(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/MainCourse_ChickenAdobo.fxml").toUri().toURL();
    ...
    @FXML
    void LechonPaksiw(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/MainCourse_LechonPaksiw.fxml").toUri().toURL();
    ...
    @FXML
    void PorkBarbeque(ActionEvent event) {
        try {
            URL url = Paths.get("./src/Inventory/views/MainCourse_PorkBarbeque.fxml").toUri().toURL();
